...
class NNumberX      
{
    private int Arr[];   //class cha characteristic // this is used in companies that Arr[] contains all resouces that means it needs to be private
...
class program223    //most important code do practice of it 
{
