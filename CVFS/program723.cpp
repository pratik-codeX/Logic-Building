...
# define ERR_INSUFFICINT_SPACE -6
...
void DisplayHelp()
{
    ...
    printf("create : It is used to create the new regualr file \n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to delete regualar file from existing file on our file system\n");
    ...
    {
        printf("Description : This command is used to display the statical information about the file regualar file\n");

        printf("Usage : stat File_name \n");
        printf("File_name : The name of file that you have to see stat \n");
    }
              ...
              )
{
    ...
    //Initailize elements of file table
    uareaobj.UFDT[i]->ReadOffset = 0;
    uareaobj.UFDT[i]->WriteOffset = 0;
    uareaobj.UFDT[i]->Count = 0;
    ...
    for(i = 0;i < MAXINODE;i++)
    {
        if(uareaobj.UFDT[i] != NULL)
        {
            if(strcmp(uareaobj.UFDT[i]->ptrinode->FileName,name) == 0)
            {
                ...
                //Deallocate the memory of file tabel
               ...
               )
{
    ...
    while(temp != NULL)
    {
        ...
        {   
            printf("-----------------Statictical Inforamtion of file-------------------");
...
//  Description :       It is used to write the conetents into the file
//  Input :             File Descriptor 
//                      Address of Buffer which contains data
//                      Size of data that we want to write
//  Output :            Number of bytes succesfully weitten into file
//  Author :            Piyush Manohar Khairnar
//  Date :              15/08/2025
//
//////////////////////////////////////////////////////////////////////////
                ...
                )
{
    ...
    printf("Date that we want to write : %s\n",data);
    printf("Number of bytes that you want to write : %d\n",size);
    ...
    while(1)        
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0],"unlink") == 0)
            {
                ...
                {
                    printf("Unlink operation is successfully deleted");
                }
                ...
                {
                    printf("Please enter the data that you want write into the file\n");
                    fgets(InputBuffer,MAXFILESIZE,stdin);

                    iRet = write_file(atoi(Command[1]),InputBuffer,strlen(InputBuffer));
                     
                    if(iRet == ERR_INSUFFICINT_SPACE)
                    {
                        printf("Insufficint space in the data block of the file\n");
                    }
